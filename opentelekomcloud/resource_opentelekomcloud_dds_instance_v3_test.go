		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDDSV3InstanceExists("opentelekomcloud_dds_instance_v3.instance", &instance),
					resource.TestCheckResourceAttr(
						"opentelekomcloud_dds_instance_v3.instance", "name", "dds-instance"),
					resource.TestCheckResourceAttr(
						"opentelekomcloud_dds_instance_v3.instance", "ssl", "true"),
				),
			},
		},
	})
...
resource "opentelekomcloud_networking_secgroup_v2" "secgroup_acc" {
  name = "secgroup_acc"
}
